            ...
            <div className="container">
                <div className="flex items-center justify-between px-4 gap-8 h-14 text-xs">
                    <div className="flex gap-6 items-center grow">
                        <Link href='/' className='font-nunitosans-extrabold shrink-0 text-base'>
                            <span>
                                HAMRAH
                            </span>
                            <span>
                        ...
                        <div className="w-full h-8 relative flex items-center">
                            <input type="text" className='h-full w-full outline-none bg-white/20 rounded-md ps-10 placeholder:text-white border-2 border-transparent focus:border-white/100' placeholder='جستجو در مبیت' />
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 absolute right-3 cursor-pointer">
                                <path fillRule="evenodd" d="M10.5 3.75a6.75 6.75 0 1 0 0 13.5 6.75 6.75 0 0 0 0-13.5ZM2.25 10.5a8.25 8.25 0 1 1 14.59 5.28l4.69 4.69a.75.75 0 1 1-1.06 1.06l-4.69-4.69A8.25 8.25 0 0 1 2.25 10.5Z" clipRule="evenodd" />
                            </svg>
                        </div>
                    </div>
                    <div className="flex gap-6 font-iransans-semiBold">
